<h2><a href="https://leetcode.com/problems/moving-average-from-data-stream/">345. Reverse Vowels of a String</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code>, reverse only all the vowels in the string and return it.</p>
