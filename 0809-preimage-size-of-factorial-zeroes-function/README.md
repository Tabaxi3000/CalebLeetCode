<h2><a href="https://leetcode.com/problems/valid-tic-tac-toe-state/">809. Preimage Size of Factorial Zeroes Function</a></h2><h3>Hard</h3><hr><p>Let <code>f(x)</code> be the number of zeroes at the end of <code>x!</code>. Recall that <code>x! = 1 * 2 * 3 * ... * x</code> and by convention, <code>0! = 1</code>.</p>
