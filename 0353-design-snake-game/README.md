<h2><a href="https://leetcode.com/problems/russian-doll-envelopes/description/">353. Design Snake Game</a></h2><h3>Medium</h3><hr><p>Design a <a href="https://en.wikipedia.org/wiki/Snake_(video_game)" target="_blank">Snake game</a> that is played on a device with screen size <code>height x width</code>. <a href="http://patorjk.com/games/snake/" target="_blank">Play the game online</a> if you are not familiar with the game.</p>
