<h2><a href="https://leetcode.com/problems/sum-of-two-integers/">370. Range Addition</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>length</code> and an array <code>updates</code> where <code>updates[i] = [startIdx<sub>i</sub>, endIdx<sub>i</sub>, inc<sub>i</sub>]</code>.</p>
