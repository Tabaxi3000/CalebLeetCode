<h2><a href="https://leetcode.com/problems/all-possible-full-binary-trees/description/">929. Groups of Special-Equivalent Strings</a></h2><h3>Medium</h3><hr><p>You are given an array of strings of the same length <code>words</code>.</p>
