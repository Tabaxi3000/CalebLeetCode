<h2><a href="https://leetcode.com/problems/trim-a-binary-search-tree/">668. Kth Smallest Number in Multiplication Table</a></h2><h3>Hard</h3><hr><p>Nearly everyone has used the <a href="https://en.wikipedia.org/wiki/Multiplication_table" target="_blank">Multiplication Table</a>. The multiplication table of size <code>m x n</code> is an integer matrix <code>mat</code> where <code>mat[i][j] == i * j</code> (<strong>1-indexed</strong>).</p>
